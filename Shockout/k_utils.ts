module Shockout {
    ...
    export class Utils {
        ...
        */
        ...
        public static logError(msg: any, errorLogListName: string, siteUrl: string = '/', debug: boolean = false): void {
        ...
        * @return boolean
        */ 
        public static compareArrays(array1: Array<any>, array2: Array<any>): Array<any> {
        ...
        public static formatPictureUrl(pictureUrl): string {
