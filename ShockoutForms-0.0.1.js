    ...
    var Templates = (function () {
        ...
        Templates.getCreatedModifiedHtml = function () {
            var template = '<div class="create-mod-info no-print"></div>' +
                ...
                '</div>';
            template = template.replace(/\{0\}/g, Shockout.ViewModel.createdByKey)
        ...
        Templates.getHistoryTemplate = function () {
            var template = '<h4>Workflow History</h4>' +
                ...
                '</tbody>' +
                '</table>'.replace(/\{0\}/g, Shockout.ViewModel.historyKey)
        ...
        Templates.getAttachmentsTemplate = function (fileuploaderId) {
            var template = '<h4>Attachments (<span data-bind="text: attachments().length"></span>)</h4>' +
